...
object StandardCapabilities {
    fun bindings(): List<CapabilityBinding> = listOf(
        ...
        CapabilityBinding("browser.read", "browser", "read", AdapterKind.NATIVE,
            metadata = meta("browser", "อ่านข้อความหน้าเว็บที่เห็น (CP-115)", listOf("tabId?"), listOf("text"), emptyList(), false, "text shown", "re-read")),
        CapabilityBinding("browser.click", "browser", "click", AdapterKind.NATIVE,
            metadata = meta("browser", "คลิก element บนหน้าเว็บ (CP-115)", listOf("selector,tabId?"), listOf("result"), emptyList(), false, "CLICKED", "check selector")),
        CapabilityBinding("browser.type", "browser", "type", AdapterKind.NATIVE,
            metadata = meta("browser", "พิมพ์ในช่องบนหน้าเว็บ ห้ามช่องรหัส (CP-115)", listOf("selector,text,tabId?"), listOf("result"), emptyList(), false, "TYPED", "check selector")),
        CapabilityBinding("browser.probe", "browser", "probe", AdapterKind.NATIVE,
            metadata = meta("browser", "ตรวจสถานะล็อกอินแบบอ่านอย่างเดียว (CP-115)", listOf("tabId?"), listOf("LOGGED_IN?"), emptyList(), false, "boolean", "re-probe")),
        // Debug engine (native).
        ...
        CapabilityBinding("render.director", "render", "director", AdapterKind.NATIVE,
            metadata = meta("render", "ให้ผู้กำกับตรวจงาน", listOf("projectId?"), listOf("verdict"), emptyList(), false, "reviewed", "retry")),
