...
/** Image engine: probe (headers) + edit (resize/crop/rotate/grayscale). */
fun imageDescriptorToday(): ToolDescriptor = ToolDescriptor(
    ...
    layers = listOf(
        ...
        LayerCapability(CapabilityLayer.CAPABILITY_API, CapabilityStatus.AVAILABLE, "info/resize/crop/rotate/grayscale"),
        LayerCapability(
