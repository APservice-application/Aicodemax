...
object IntentParser {
    ...
    fun parse(text: String): UserIntent {
        ...
        if (containsAny(t, ThaiVocabulary.camTrackWords)) {
            return UserIntent(IntentType.CAM_TRACK, text, params("clipIndex" to parseClipIndex(t)))
        }
        ...
        if (containsAny(t, ThaiVocabulary.lipsyncWords)) {
            return UserIntent(IntentType.LIPSYNC, text, params("clipIndex" to parseClipIndex(t)))
        }
