...
**สถานะ:** ส่วน BYOK/chat บน `feature/android-byok-multiprovider-ai-2026` commit `99ce52e` ผ่าน JVM/Android unit tests, host real-inference smoke test และ assembleDebug + APK artifact จาก [CI 36227480479](https://github.com/APservice-application/Aicodemax/actions/runs/36227480479). **ยังไม่ทดสอบคีย์ผู้ให้บริการ/เครื่องจริง และยังไม่ครบ `all_models_now`**; ไม่ใช่ release. Branch ใหม่ [Qwen3-1.7B bundled QA](android-bundled-qwen3-1p7b-2026-09-26.md) แตกจาก checkpoint นี้เพื่อเปลี่ยนตัว AI ใน APK โดยไม่เปลี่ยนโมเดล API.
